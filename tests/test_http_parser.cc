...
void test_request(const char *str) {
    LT::http::HttpRequestParser parser;
    std::string tmp = str;
    ...
    if (parser.hasError()) {
        ...
        LT::http::HttpRequest::ptr req = parser.getData();
        std::cout << req->toString() << std::endl;
    }
}

void test_response(const char *str) {
    LT::http::HttpResponseParser parser;
    std::string tmp = str;
    ...
    if (parser.hasError()) {
        ...
        LT::http::HttpResponse::ptr rsp = parser.getData();
