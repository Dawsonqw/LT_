#ifndef __LT_FIBER_H__
#define __LT_FIBER_H__
...
public:
    ...
    /**
     * @brief 协程状态
     * @details 在LT基础上进行了状态简化，只定义三态转换关系，也就是协程要么正在运行(RUNNING)，
...
public:
     ...
     */
    Fiber(std::function<void()> cb, size_t stacksize = 128*1024, bool run_in_scheduler = true);
