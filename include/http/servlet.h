#ifndef __LT_HTTP_SERVLET_H__
#define __LT_HTTP_SERVLET_H__
...
public:
     ...
     * @return 是否处理成功
     */
    virtual int32_t handle(LT::http::HttpRequest::ptr request
                   , LT::http::HttpResponse::ptr response
                   , LT::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (LT::http::HttpRequest::ptr request
                   , LT::http::HttpResponse::ptr response
                   , LT::http::HttpSession::ptr session)> callback;
    ...
    virtual int32_t handle(LT::http::HttpRequest::ptr request
                   , LT::http::HttpResponse::ptr response
                   , LT::http::HttpSession::ptr session) override;
private:
    /// 回调函数
    callback m_cb;
};
