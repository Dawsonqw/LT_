...
Socket::ptr Socket::CreateUDP(LT::Address::ptr address) {
...
bool Socket::cancelRead() {
    return IOManager::GetThis()->cancelEvent(m_sock, LT::IOManager::READ);
}

bool Socket::cancelWrite() {
    return IOManager::GetThis()->cancelEvent(m_sock, LT::IOManager::WRITE);
}
...
[root@ecs-76179 src]# ls
address.cc     fiber.cc  iomanager.cc  scheduler.cc  tcp_server.cc  timer.cc
fd_manager.cc  hook.cc   mutex.cc      socket.cc     thread.cc      util.cc
[root@ecs-76179 src]# cat tcp_server.cc 
#include <string.h>
#include <sstream>
