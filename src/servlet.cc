...
int32_t FunctionServlet::handle(LT::http::HttpRequest::ptr request
               , LT::http::HttpResponse::ptr response
               , LT::http::HttpSession::ptr session) {
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("LT/1.0"));
}

int32_t ServletDispatch::handle(LT::http::HttpRequest::ptr request
               , LT::http::HttpResponse::ptr response
               , LT::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(LT::http::HttpRequest::ptr request
                   , LT::http::HttpResponse::ptr response
                   , LT::http::HttpSession::ptr session) {
    response->setStatus(LT::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "LT/1.0.0");
